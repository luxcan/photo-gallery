...
public sealed class Album
{
    ...
    /// album's rule, or null where the rule says nothing about dates.
    /// </summary>
    /// <remarks>
    /// A rule is what makes an album something you can add to rather than
    ...
    public List<AlbumRulePerson> RulePeople { get; } = [];

    /// <summary>The places a photograph may have been taken in. Any of them.</summary>
    public List<AlbumRulePlace> RulePlaces { get; } = [];

    /// <summary>Whether this album has anything to look for.</summary>
    public bool HasRule =>
