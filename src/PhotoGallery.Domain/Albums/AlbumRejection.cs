...
/// <summary>
/// A photograph the user has said does not belong in an album covering
/// these days.
/// </summary>
/// <remarks>
/// Keyed on the span rather than on the album row, so it survives the
...
/// a silent no.</para>
/// </remarks>
public sealed class AlbumRejection
{
