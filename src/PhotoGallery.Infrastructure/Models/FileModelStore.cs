...
public sealed class FileModelStore : IModelStore
{
    ...
    public FileModelStore(IWorkingFolder workingFolder, ModelManifest manifest)
    {
    ...
    public string ResolvePath(ModelId id) =>
        Path.Combine(_workingFolder.ModelsPath, _manifest.For(id).FileName);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Directory.CreateDirectory(_workingFolder.ModelsPath);
