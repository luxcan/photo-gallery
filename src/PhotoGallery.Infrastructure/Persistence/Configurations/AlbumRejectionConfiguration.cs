...
public sealed class AlbumRejectionConfiguration
    : IEntityTypeConfiguration<AlbumRejection>
{
    public void Configure(EntityTypeBuilder<AlbumRejection> builder)
    {
        builder.ToTable("AlbumRejections");

        // Keyed on the span rather than on the album row, so the memory
