...
/// </summary>
/// <remarks>
/// Separate from the repository that stores albums because it answers
/// about photographs rather than about albums, and because the naming rung
/// a group lands on depends on how far it is from home - which only the index
/// can say.
/// </remarks>
public interface IAlbumFactsReader
{
    /// <summary>
    /// The places and people in these photographs, commonest first, with the
    /// kind the clusterer settled on.
    /// </summary>
    Task<AlbumFacts> DescribeAsync(
        PhotoGroup group,
