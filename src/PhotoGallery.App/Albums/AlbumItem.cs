...
/// <summary>One album as a row in the list.</summary>
/// <remarks>
...
/// </remarks>
public sealed record AlbumItem(AlbumSummary Summary, ImageSource? Cover)
{
    public int Id => Summary.Id;

    public string Name => Summary.Name;

    public bool IsProposed => Summary.Origin == AlbumOrigin.Proposed;

    public bool IsMine => Summary.Origin != AlbumOrigin.Proposed;
    ...
    /// </remarks>
    public string KindLabel => Summary.Kind == AlbumKind.Trip ? "Trip" : string.Empty;
    ...
    private string Span
    {
        get
        {
            if (Summary.Origin == AlbumOrigin.Made && Summary.PhotoCount == 0)
            {
                return string.Empty;
            }
